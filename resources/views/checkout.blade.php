...
<form class="mx-5" method="POST" action="{{ route('placeOrder') }}">
      <h2 class="pt-5">Billing and shipping address</h2>
      @csrf
 <div class="row">
...
<?php $total = 0 ?>
 <table  class=" table  table-lg shadow" >
        <thead>
        <tr>
        ...
        <tbody>
            ...
            <a href="{{ route('cart') }} "><button class="btn btn-block shadow">change cart</button></a>
