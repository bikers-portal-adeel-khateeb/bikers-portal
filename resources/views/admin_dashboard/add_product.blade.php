...
<div class="container mt-0 shadow" style="background-color: white"> <br />
  <h4 class="text-muted">Add Product</h4> <br />
              ...
              <label for="model" class="col-sm-2 col-form-label">Model</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="model" 
                    placeholder="Enter product model" name="model" required>
                </div>
            </div>
            <div class="form-group row">
